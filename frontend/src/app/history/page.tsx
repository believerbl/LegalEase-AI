  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-50 p-8">
      ...
      >
        ...
        <h1 className="text-3xl font-bold mb-4">Document History</h1>
        <p className="text-neutral-400 max-w-md">
          This feature is currently under development for the hackathon. Soon, you will be able to view and search all your previously analyzed legal documents here!
        </p>
      </motion.div>
    </div>
  );
